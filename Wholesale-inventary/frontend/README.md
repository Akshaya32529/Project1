...
The app uses `https://project1-6-y1bz.onrender.com/api` by default. To change it from the browser console:

```js
localStorage.setItem("apiBase", "https://project1-6-y1bz.onrender.com/api");
```
